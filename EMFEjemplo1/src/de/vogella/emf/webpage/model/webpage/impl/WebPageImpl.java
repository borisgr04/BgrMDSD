...
public class WebPageImpl extends EObjectImpl implements WebPage {
	...
	public NotificationChain basicSetCategories(Category newCategories, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WebpagePackage.WEB_PAGE__CATEGORIES, oldCategories, newCategories);
	...
	public void setCategories(Category newCategories) {
		if (newCategories != categories) {
			...
			if (categories != null)
				msgs = ((InternalEObject)categories).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WebpagePackage.WEB_PAGE__CATEGORIES, null, msgs);
			if (newCategories != null)
				msgs = ((InternalEObject)newCategories).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WebpagePackage.WEB_PAGE__CATEGORIES, null, msgs);
			msgs = basicSetCategories(newCategories, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebpagePackage.WEB_PAGE__CATEGORIES, newCategories, newCategories));
	}
