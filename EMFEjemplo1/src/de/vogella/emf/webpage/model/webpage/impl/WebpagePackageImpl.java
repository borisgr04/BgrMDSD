...
public class WebpagePackageImpl extends EPackageImpl implements WebpagePackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getCategory_Pages(), this.getMyWeb(), null, "pages", null, 0, 1, Category.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
